...
//----------->>>>> PAGE
$itemPerPage = 15;
$ttl = $db->query("SELECT COUNT(*) FROM wd WHERE status='1'")->fetch();
...
$ddaa = $db->query("SELECT id, method, usr, amount, charge, tm, details, msg, status, trx FROM wd WHERE status='1' ORDER BY id DESC LIMIT ".$start.",".$itemPerPage."");
$boxtext = "Withdraw Log - Success";
...
$prevnum=$page-1;
$prev ="<li> <a href=\"$adminurl/WithdrawSuccess/$prevnum\"> &lt;&lt;</a> </li>";
if($page<="1"){
...
echo "<li><a href=\"$adminurl/WithdrawSuccess/$pSt\"> $pSt</a> </li> ";
}

$pSt++;
}
$nextnum=$page+1;
$next ="<li> <a href=\"$adminurl/WithdrawSuccess/$nextnum\">&gt;&gt;</a> </li> ";
if($page>=$tpg){
