				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
							<h1 class="text-white">FILLIT Support</h1>
							<h2 class="text-white">What can we help you with?</h2>
							<a href="about-us.php" class="btn btn-primary btn-white">About Us</a>
							<a href="contact-us.php" class="btn btn-primary btn-white btn-filled">Contact Us</a>
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="feature feature-icon-large">
								<div class="pull-left myhover">
									<i class="fa fa-paper-plane" data-scroll-reveal="enter left and move 30px aria-hidden="true"></i>
								</div>
								<div class="pull-right">
									<h5><a href="getting-started.php">Getting Started</a></h5>
									<p>
										Here we go!
									</p>
								</div>
						...
						<div class="col-sm-6">
							<div class="feature feature-icon-large">
								<div class="pull-left myhover">
									<i class="fa fa-credit-card" data-scroll-reveal="enter left and move 30px aria-hidden="true"></i>
								</div>
								<div class="pull-right">
									<h5><a href="debit_card.php">FILLIT Prepaid Card</a></h5>
									<p>
						...
						<div class="col-sm-6">
							<div class="feature feature-icon-large">
								<div class="pull-left myhover">
									<i class="fa fa-user" data-scroll-reveal="enter left and move 30px aria-hidden="true"></i>
								</div>
								<div class="pull-right">
									<h5><a href="account_verification.php">Account Verification</a></h5>
									<p>
										A few insights on verification of you FILLIT account.
									</p>
								</div>
							</div>
						</div><!--end 6 col-->
						...
						<div class="col-sm-6">
							<div class="feature feature-icon-large">
								<div class="pull-left myhover">
									<i class="fa fa-lock" data-scroll-reveal="enter left and move 30px aria-hidden="true"></i>
								</div>
								<div class="pull-right">
						...
						<div class="col-sm-6">
							<div class="feature feature-icon-large">
								<div class="pull-left myhover">
									<i class="fa fa-money" data-scroll-reveal="enter left and move 30px aria-hidden="true"></i>
								</div>
								<div class="pull-right">
									<h5><a href="loading-funds.php">Loading Funds</a></h5>
									<p>
										How to? How long? Rates applied
									</p>
								</div>
							</div>
						</div><!--end 6 col-->
						...
						<div class="col-sm-6">
							<div class="feature feature-icon-large">
								<div class="pull-left myhover">
									<i class="fa fa-exclamation-triangle" data-scroll-reveal="enter left and move 30px aria-hidden="true"></i>
								</div>
								<div class="pull-right">
									<h5><a href="error-fails.php">Errors and Fails</a></h5>
									<p>
										**it happens
