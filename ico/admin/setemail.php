...
$res = $db->query("UPDATE general_setting SET notimail='".$notimail."', emailtemp='".$btext."' WHERE id='1'");
...
if ($err1 == 1){
notification("Email Can Not be Empty!", "Please Check..", "error", false, "btn-success", "OKAY");
}		
}
}

$old = $db->query("SELECT notimail, emailtemp FROM general_setting WHERE id='1'")->fetch();
?>										
