...
if (isset($_POST['username'])) {
	...
	$ddaa = $db->query("SELECT id, firstname, lastname, mobile, email, mallu FROM users WHERE ev='1' AND mv='1' AND firstname LIKE '%".$search."%' OR ev='1' AND mv='1' AND lastname LIKE '%".$search."%'  ORDER BY id ASC LIMIT ".$start.",".$itemPerPage."");
