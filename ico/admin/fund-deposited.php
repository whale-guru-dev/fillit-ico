    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                $ddaa = $db->query("SELECT id, usid, tm, method, amount, charge, amountus, bcam, trx, trx_ext, paypal_em FROM deposit_data WHERE status='1' ORDER BY id DESC LIMIT ".$start.",".$itemPerPage."");
                $ddaax = $db->query("SELECT id,name, email, pkid, pknr, date, status FROM wire_requests WHERE status='1' ORDER BY id DESC LIMIT ".$start.",".$itemPerPage."");
...
<td class='bold'> $data[4] </td>

<td class='bold'> $data[5]  </td>
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption">
                                    ...
                                    <i class="fa fa-list"></i>  <?php echo "Wire Requests"; ?>
                                ...
                                if ($ttl[0]==0) {
                                    ...
                                    <div class="table-scrollable">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            while ($data = $ddaax->fetch()) {



                                                $UserDetails = $db->query("SELECT firstname, lastname, email FROM users WHERE email='".$data[2]."'")->fetch();
                                                $eurica = $db->query("SELECT val2 FROM deposit_packages WHERE id='".$data[3]."'")->fetch();
               $eurica = $eurica[0] * $data[4];
                            $cancixa=strtotime($data[5]);
                                                $dt = date("dS F Y - h:i A ", $cancixa);
...
<td> $UserDetails[0] $UserDetails[1]</td>

<td class='bold'> $data[3] </td>

<td class='bold'> $data[4]  </td>
<td class='bold'> $eurica</td>
<td class='bold'> $dt </td>
