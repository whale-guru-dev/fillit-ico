...
if (isset($_POST['username'])) {
	...
	$ddaa = $db->query("SELECT id, firstname, lastname, mobile, email, mallu FROM users WHERE block='1' AND firstname LIKE '%".$search."%' OR block='1' AND lastname LIKE '%".$search."%'  ORDER BY id ASC LIMIT ".$start.",".$itemPerPage."");
// $ddaa = $db->query("SELECT id, firstname, lastname, mobile, email, mallu FROM users WHERE firstname LIKE '%".$search."%'"."AND lastname LIKE '%".$search."%'");
