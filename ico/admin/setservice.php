...
<h3 class="page-title  uppercase bold"> <i class="fa fa-desktop"></i> Service Setting
...
$res = $db->query("INSERT INTO service SET icon='".$icon."', btxt='".$btxt."', stxt='".$stxt."'");
if($res){
...
<div class="col-md-5">
<input class="form-control input-lg" name="stxt" type="text">
</div>
