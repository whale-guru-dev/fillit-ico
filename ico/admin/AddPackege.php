...
<h3 class="page-title uppercase bold"> Add New Packege
<a href="<?php echo $adminurl; ?>/Packege" class="btn btn-success btn-md pull-right">
...
if ($error == 0){
$res = $db->query("INSERT INTO packs SET name='".$name."', details='".$btext."', minamo='".$min."', maxamo='".$max."', charged='".$charged."', chargep='".$chargep."', limit30='".$limit30."'");
...
<div class="col-md-12">
<textarea id="shaons" class="form-control" rows="3" name="btext"></textarea>
</div>
</div>
...
<input class="form-control input-lg" name="min" value="" type="text">
...
<div class="col-md-12">
<div class="input-group mb15">
<input class="form-control input-lg" name="max" value="" type="text">
<span class="input-group-addon"><?php echo $basecurrency; ?></span>
</div>
</div>
</div>
...
<div class="col-md-12">
<div class="input-group mb15">
<input class="form-control input-lg" name="limit30" value="" type="text">
<span class="input-group-addon"><?php echo $basecurrency; ?></span>
</div>
</div>
</div>  
...
<div class="row">
<div class="col-md-12">
<button type="submit" class="btn blue btn-block btn-lg">ADD PACKEGE</button>
</div>
</div>
