...
<h3 class="page-title uppercase bold"> View Menu  
<a href="<?php echo $adminurl; ?>/AddMenu" class="btn btn-primary btn-md pull-right">
...
<a href=\"$adminurl/EditMenu/$data[0]\"><button class=\"btn purple btn-sm\"> <i class=\"fa fa-edit\"></i> EDIT</button></a>
