        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <span class="text-white alt-font">Account Verification</span>
                    <h1 class="text-white">Information on account verification</h1>
                </div>
            </div><!--end of row-->
        </div><!--end of container-->
    </header>
                    ...
                    <ul class="expanding-ul">
                        <li>
                            <div class="title">
                                ...
                                <span><strong>Q: What documents should I submit to verify my account?</strong></span>
                            </div>

                            <div class="text-content">
                                <p>
                                    A: We require two documents to be provided to verify your FILLIT account.
<br>
                                    Photo ID<br>
                                    Should be valid in Europe. Photo should be as bright, sharp and clear as possible, without any modifications such as cropping, resizing or any other corrections, preferably copied directly from your smartphone's camera.
<br>
                                  <br>
                                    Proof of address<br>
                                    Document should be as bright, clean and sharp as possible and should be issued earlier than 90 days ago.
                                </p>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="title">
                                <i class="icon icon-pencil"></i>
                                <span><strong>Q: I received a message saying that my information is currently being reviewed. </strong></span>
                            </div>

                            <div class="text-content">
                                <p>
                                    A:This message means that your documents were received and your account is under review. Once it finished, we will inform you with an outcome via separate email.
<br>
                                    Normally the process takes 5-12 business days.
                                </p>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="title">
                                <i class="icon icon-pencil"></i>
                                <span><strong>Q: How long does verification take?</strong></span>
                            </div>

                            <div class="text-content">
                                <p>
                                    A:In most cases, review takes around 5-12 business days.
                                </p>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="title">
                                <i class="icon icon-pencil"></i>
                                <span><strong>Q: Why do I need to verify my account?</strong></span>
                            </div>

                            <div class="text-content">
                                <p>
                                    A:As an authorized e-money provider, in order to comply with EU and UK AML legislation, FILLIT is required to verify the identity of its customers once certain criterias are met, such as total card annual turnover, ATM limits or requirement to fund the card from third-party merchants such as PayPal.
                                </p>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="title">
                                <i class="icon icon-pencil"></i>
                                <span><strong>Q: How to pass FILLIT verification?</strong></span>
                            </div>

                            <div class="text-content">
                                <p>
                                    A:To get verified, in you are required to provide 3 documents:
<br>
                                    <br>
                                    Photo ID<br>
                                    Please submit a photo or scan of a valid international ID card, driver's license or a passport. The image should have at least 300 dpi resolution, and should be at least 500 KB in size, and in color. Please do not edit it in any way (cropping, resizing, blurring), it should be sent to us exactly "as is". Please do it as bright and sharp as possible.
                                    <br><br>
                                    Proof of Address<br>
                                    Required to confirm your residential address. A document should be bright, clean, and not older than 90 days. We accept:<br>
                                    - Utility bills for gas, electricity, cable TV, broadband Internet or phone. Mobile phone bills are not accepted;<br>
                                    - Certificate of residency issued by your local government representative;<br>
                                    - Bank statement with your name, surname and full address;<br>
                                    - Tax report.<br>
<br>
                                    If your ID has an address written on it - we can not accept that, Proof of Address should be a separate document.
