...
if (isset($_POST['username'])) {
	...
	$ddaa = $db->query("SELECT id, firstname, lastname, mobile, email, mallu FROM users WHERE ev='0' AND firstname LIKE '%".$search."%' OR ev='0' AND lastname LIKE '%".$search."%'  ORDER BY id ASC LIMIT ".$start.",".$itemPerPage."");
